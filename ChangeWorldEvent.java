...
public class ChangeWorldEvent extends EventArea {
	
	public World target;
	public ChangeWorldEvent(Game game, World w, float x, float y, int width, int height) {
