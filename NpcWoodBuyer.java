...
public class NpcWoodBuyer extends Creature {
	...
	public String message[] = {"Hi there", "I'll buy all the wood you have.", "Thanks!"}; 
	
	public int mesgIndex = 0;
	
	private Rectangle radar;

	public NpcWoodBuyer(Game game, World w, float x, float y) {
	...
	public void hurt(Item i) {
		...
		if (i.name == "wood") {
			mesgIndex = 2;
			world.getEntityManager().getPlayer().cash+=(5 * i.getCount());
