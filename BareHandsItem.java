...
public class BareHandsItem extends Item {
	
	public BareHandsItem(Game game, World w, String name, int id) {
	...
	public void render(Graphics g, int x, int y) {
		...
		g.drawImage(Assets.axe_item,x,y,ITEMWIDTH,ITEMHEIGHT,null);
	}
