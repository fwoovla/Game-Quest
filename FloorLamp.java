...
public class FloorLamp extends StaticEntity {
	
	public FloorLamp(Game game, World w, float x, float y) {
	...
	public void render(Graphics g) {
		...
		g.drawImage(Assets.floor_lamp,(int) (x - world.getGameCamera().getxOffset()),(int) (y - world.getGameCamera().getyOffset()), width, height, null);
