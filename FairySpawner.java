//Fairy Spawner event area


import java.awt.Graphics;
import java.awt.Color;

public class FairySpawner extends EventArea {
	

	public FairySpawner(Game game, World w, float x, float y, int width, int height) {
	...
	public void tick() {
		if(world.getEntityManager().getPlayer().getCollisionBounds(0,0).intersects(getCollisionBounds(0,0))) {
			isOver = true;
			System.out.println("Fairies are here");
